...
<a href="page.jsp" style="text-decoration:none;margin-top:25px;color:#000000;font-family: 'Newsreader', serif;font-weight:bolder;">
<div class="name">
<p>Mentor</p>
</div>
</a>
...
if(l!=null){
 ...
 %>
 <a id="fp" href="login.jsp"><button class="but" id="log" onclick="init()" href="login.jsp" style=" font-size:15px;">Login</button></a>
 <a id="fp" href="details.jsp"><button  class="but" id="sig" onclick="init()" href="details.jsp" style=" font-size:15px;">Signup</button></a>
 <% 
 } 
}
else{
