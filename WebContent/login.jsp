...
<div class="whole">
<div >
  <p class="infor">Welcome !</p>
  <form  class="logd" method="post" action="login" autocomplete="off" >
      <div>
        <p class="lab">Email</p>  
       ...
       <div id="forcon">
          <a href="changepass.jsp" id="forp">forgot password ?</a>
      </div>
      <button type="submit" class="inputs" id="bu">Login</button>
  </form>
  <p id="suthi">New to Mentor ? <a href="details.jsp" class="cra">Create account</a></p>
</div>
