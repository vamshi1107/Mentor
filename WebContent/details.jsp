...
<script>
 ...
 function nextk(e){
		  var va=document.getElementById("inpu").value
		  if(va!=""){
		   document.getElementById(e.srcElement.parentElement.parentElement.id).style.marginLeft="-60vw";
		  }
  ...
  function move(e){
	  ...
	  if(email!="" && email !=null && pa !="" && pa !=null){
		  document.getElementById(e.srcElement.parentElement.id).style.marginLeft="-60vw";
...
<div id="pg">
  ...
  <form   method="post" action="newuser"  id="form" autocomplete="off">
  <div class="container">
   <div class="coni" id="it">
        <div>
         <p class="lab">Name</p>
          <input type="text" name="name" autocomplete="off" class="inputs" required >
       </div>
      <div>
        <p class="lab">Email</p>  
        <input type="text" name="email" autocomplete="off" class="inputs" id="email" oninput="val(event)">
      </div>
       <div>
         <p class="lab">Password</p>
          <input type="password" name="password" autocomplete="off" class="inputs" id="pa">
       </div>
    ...
    <div class="coni" id="it1">
       ...
       <div>
        ...
        <input type="text" name="profession" autocomplete="off" class="inputs" id="em">
       </div>
       <div>
         <p class="lab">Company / College</p>
          <input type="text" name="company" autocomplete="off" class="inputs">
       </div>
       <div>
           <button class="newc"
     ...
     <div  class="coni" id="it2">
       ...
       <input type="text" name="image" id="imin" style="visibility:hidden;">
       <div id="menin" style="margin-bottom:10px;">
          <div class="lab">Do you want to be mentor ?</div>
          <div>
             <input type="checkbox" name="mentor" onchange="calend(this)" autocomplete="off" class="men" value="true">
          </div>
       </div>
       <div>
          <input type="text" name="calendly" autocomplete="off" class="inputs" id="calendly" placeholder="Calendly link" oninput="cal()" onchange="cal()">
       </div>
       <div>
           <button class="newc" type="button" onclick="back(event)">Back</button>
           <button class="inputs extr" id="butt" type="button" onclick="nextk(event)">Next</button>
        </div>
     </div>
     ...
     <div  class="coni" id="it3">
        ...
        <input type="text" name="language" autocomplete="off" class="inputs"  required>
        </div>
         <div>
        <p class="lab">Social media link</p>  
        <input type="text" name="social" autocomplete="off" class="inputs"  required>
        </div>
        <div>
        <p class="lab">About you</p>  
        <input type="text" name="about" autocomplete="off" class="inputs"  style="margin-bottom:5px;height:90px" >
       </div>
       <div>
           <button class="newc" type="button" onclick="back3(event)">Back</button>
           <button class="inputs extr" id="bu" type="submit" >Create</button>
        </div>
     </div>
