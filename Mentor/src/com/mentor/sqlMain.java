...
public class sqlMain {
	...
	sqlMain(){
		...
		try {
			...
			this.con=(PgConnection) DriverManager.getConnection(cr.url,cr.user,cr.pass);
...
public  ArrayList<Mentor> GetAll() throws ClassNotFoundException, SQLException {
	...
	PgStatement smt=(PgStatement) con.createStatement();
...
public ArrayList<review>  GetReview(String email) throws ClassNotFoundException, SQLException {
	...
	PgStatement smt=(PgStatement) con.createStatement();
	String q="select u.name,u.email,r2.review,u.mentor from users u inner join review r2 on u.email like r2."+new Credentials().op+" and r2.mentor like "+"'"+email+"' ;";
...
Boolean isAdmin(String email,String pass) throws ClassNotFoundException, SQLException {
	PgStatement s=(PgStatement) con.createStatement();
